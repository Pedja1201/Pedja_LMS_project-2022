...
public class Logger {
    ...
    @Around("execution(* rs.ac.singidunum.isa.app.controller.AdministratorController.*(Long))")
    ...
    @After("execution(* rs.ac.singidunum.isa.app.controller.AdministratorController.*(Long)) && args(id,..)")
