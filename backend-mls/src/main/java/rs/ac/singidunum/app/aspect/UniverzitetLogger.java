...
import rs.ac.singidunum.app.service.UniverzitetLogService;
...
public class UniverzitetLogger {
    ...
    @Around("execution(* rs.ac.singidunum.app.controller.UniverzitetController.*(Long))")
    ...
    @After("execution(* rs.ac.singidunum.app.controller.UniverzitetController.*(Long)) && args(id,..)")
