...
public class StudijskiProgramLogger {
    ...
    @Around("execution(* rs.ac.singidunum.app.controller.StudijskiProgramController.*(Long))")
    ...
    @After("execution(* rs.ac.singidunum.app.controller.StudijskiProgramController.*(Long)) && args(id,..)")
